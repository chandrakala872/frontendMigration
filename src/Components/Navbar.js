...
//         <Link
//           to="/"
//           className={`navbar-item ${location.pathname === "/welcome" ? "active-link" : ""}`}
//           onClick={() => setMobileMenuOpen(false)}
//         >
//           Home
//         </Link>
...
//       {/* Navigation menu - shown for all users but content differs */}
//       <div className={`navbar-menu ${isMobileMenuOpen ? "active" : ""}`}>
//         {isAuthenticated ? (
...
// this is new navbar working with Auth
