...
const AnalysisPage = () => {
  ...
  return (
    <div className="analysis-container">
      <h1 className="analysis-heading">SourceDatabase Migration Analysis</h1>
      
      <div className="summary-row">
        <div className="summary-card database-card">
          <h3 className="card-heading">Databases</h3>
          <p className="card-value">{metadata.totalDatabases}</p>
        </div>
        
        <div className="summary-card collection-card">
          <h3 className="card-heading">Collections</h3>
          <p className="card-value">{metadata.totalCollections}</p>
        </div>
        
        <div className="summary-card document-card">
          <h3 className="card-heading">Documents</h3>
          <p className="card-value">{metadata.totalDocuments.toLocaleString()}</p>
        </div>
      </div>

      <div className="data-size-container">
        <h2 className="data-size-heading">Storage Metrics</h2>
        <div className="summary-row">
          <div className="summary-card logical-size-card">
            <h3 className="card-heading">Logical Data Size</h3>
            <p className="card-value">{metadata.logicalDataSize}</p>
          </div>
          
          <div className="summary-card storage-size-card">
            <h3 className="card-heading">Storage Size</h3>
            <p className="card-value">{metadata.storageSize}</p>
          </div>
        </div>
      </div>
