...
// // this is correctly upto websocket and time 
...
//           {migrationStarted && (
//             <Migrationwebsocket
//               migrationBatch={effectiveMongoCollections.flatMap(mongoCol =>
//                 effectiveCouchCollections.map(couchCol => ({
//                   source: { 
